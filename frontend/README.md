...
| Service | URL |
|---------|-----|
| 🖥️ **Web App (Frontend)** | [https://plant-net-client-eta.vercel.app](https://plant-net-client-eta.vercel.app) |
| ⚙️ **Backend API** | [https://plant-net-server-six.vercel.app](https://plant-net-server-six.vercel.app) |
